...
class MilkRateController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'snf_8_3' => 'nullable|numeric',
            'snf_8_4' => 'nullable|numeric',
            'snf_8_5' => 'nullable|numeric',
            'snf_8_6' => 'nullable|numeric',
            'snf_8_7' => 'nullable|numeric',
            'snf_8_8' => 'nullable|numeric',
            'snf_8_9' => 'nullable|numeric',
            'snf_9_0' => 'nullable|numeric',
        ]);
      
        try{
            $milkRate = MilkRate::create($data);
        return response()->json(
            $milkRate, 201
        );
        }
